...
public class SysLogAspect {
	...
	@Pointcut("execution(* com.jk.controller.UserController.LoginUser(..))")
    ...
    public void myAfter(JoinPoint jp,Object returningValue) throws UnknownHostException {//returningValue是返回值，但需要告诉spring
        ...
        log.setPatternurl(jp.getTarget().getClass() +"/"+ jp.getSignature().getName());
        
        //car.setReturningValue( returningValue);
	...
	//	HttpServletRequest request =((ServletRequestAttributes) RequestContextHolder.getRequestAttributes()).getRequest();
		HttpServletRequest request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();
		//int attribute = (Integer) request.getSession().getAttribute("flag");
		//Object flag = request.getSession().getAttribute("flag");
		User user = (User) request.getSession().getAttribute("loginUser");
	
		//log.setFlag(attribute);
